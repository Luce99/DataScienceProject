...
#import dataframes
df_mun = pd.read_excel('C:\\data\\dfsample\\speciesByMunicipality.xlsx', engine='openpyxl')
df_consolidated = pd.read_excel('C:\\data\\dfsample\\consolidatedTableByYear.xlsx', engine='openpyxl')
df_eb = pd.read_excel('C:\\data\\dfsample\\ebdSummaryVisits.xlsx', engine='openpyxl')
clusters = pd.read_csv('C:\\data\\dfsample\\ClustersCSV.csv')
