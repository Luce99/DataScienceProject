...
class mapClusters:
    ...
    """
    def __init__(self,map_title:str, ID:str,df,column):
        """__init__ _summary_
    ...
    def figura(self):
        ...
        geojson=municipios, 
        locations=self.df.COD_DANE, 
        featureidkey='properties.DPTOMPIO',
        z=self.df[self.column],
        colorscale='dense',
        text=self.df.NOM_MPIO,
        marker_opacity=0.9, 
    ...
    def display(self):   
        layout = html.Div(
            [
                ...
                html.Div([
                    dcc.Graph(figure=mapClusters.figura(self), id=self.id)
                ])
